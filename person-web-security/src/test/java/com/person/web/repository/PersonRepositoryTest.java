...
class PersonRepositoryTest {
    ...
    public void testFindById() {
        assertEquals(Optional.of(this.p1), this.personRepository.findById(this.p1.getId()));
        assertEquals(Optional.of(this.p2), this.personRepository.findById(this.p2.getId()));
    }
